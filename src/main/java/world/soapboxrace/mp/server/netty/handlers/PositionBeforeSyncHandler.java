...
public class PositionBeforeSyncHandler extends BaseHandler
{
    @Override
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception
    {
        ...
        if (isPosBeforeSync(data))
        {
            logger.debug("got pos before sync");
    ...
    private boolean isPosBeforeSync(byte[] data)
    {
